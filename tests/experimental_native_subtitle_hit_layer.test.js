...
function backendFontMetricResult(
  ...
  return {
    ok: true,
    metricResolverVersion: 4,
    metricSource: "coretext-libass-os2-win-v4",
    libassProviderVerified: true,
    resolvedFontFormat: 1,
    resolvedPostScriptName,
    resolvedFamilyName:
...
(async () => {
  ...
  assertEqual(
    fallbackCopy.children[1].style["font-size"],
    1.04489795918 / TEST_FONT_METRICS.fontMetricScale + "em",
    "fallback rendering scales the face to its native advance metrics",
  );
  assert(
