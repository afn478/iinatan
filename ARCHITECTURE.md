...
- `src/main/55_anki_integration.js` mixes AnkiConnect transport, media capture, template expansion, duplicate decisions, manager state, and overlay bridge handling.
